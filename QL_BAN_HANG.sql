...
VALUES 
	('QL00000001',N'CHU MINH HIỆP','0394599501',N'BA-VÌ',0,'1/1/2020','ADMIN@GMAIL.COM','nv00001','123456',2),
	('KT00000001',N'CHU MINH HIỆP 1','0394599502',N'Hà Nội',1,'1/1/2020','ADMIN1@GMAIL.COM','nv0002','123456',1),
	('NV00000001',N'CHU MINH HIỆP 2','0394599503',N'Hồ Chí Minh',0,'1/1/2020','ADMIN2@GMAIL.COM','nv0002','123456',0);
...
BEGIN
	...
	CASE NHAN_VIEN.CHUC_VU when 0 then N'Nhân Viên' when 1 then N'Kế Toán' else N'Quản Lý' end as CHUC_VU ,
	CASE NHAN_VIEN.TRANG_THAI  when 0 then N'Hoạt Động' when 1 then N'Đã Tắt' when 2 then N'Đang làm'when 3 then N'Nghỉ Việc' else N'Đã Chặn !!!'  end as TRANG_THAI
	FROM NHAN_VIEN 
...
select * from KHACH_HANG where ma_kh like '%%';
